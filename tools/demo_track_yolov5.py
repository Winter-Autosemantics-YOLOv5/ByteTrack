...
def make_parser():
    ...
    parser.add_argument("--legacy", dest="legacy", default=True, action="store_true", help="To be compatible with older versions",)
...
if __name__ == "__main__":
    '''
    python tools/demo_track_yolov5.py \
        video \
        --conf 0.25 \
        --nms 0.7 \
        -f exps/example/mot/yolov5_s_mix_det.py \
